...
# path первый аргумент route отображает маршрут, второй аргумент ссылка на представление
urlpatterns = [
...
if settings.DEBUG:
    urlpatterns += static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)  # для отображения наших медиа
